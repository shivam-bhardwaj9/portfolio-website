...
const Contact = () => {
  return (
    <div className='bg-gray-300 h-180 flex items-center flex-col' id='contact'>
      ...
      <div className='bg-gray-100 w-200 h-110 pt-10  rounded-xl flex flex-col items-center'>
        <h1 className=' pb-10 uppercase font-bold'>Let’s Work Together 🚀 </h1>
        <a href="www.linkedin.com/in/shivam-bhardwaj-a90539253" target="blank">Linkedin</a>
