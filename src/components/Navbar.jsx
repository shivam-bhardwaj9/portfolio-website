...
const Navbar = () => {
  return (
    <div className='bg-white opacity-80 fixed h-30 top-0 w-full flex items-center justify-between px-10 z-20 max-w-screen' id='#hello'>
    <div className='flex items-end '>
      <a href="/"><img src={logo} alt="logo" className='h-15 pl-10 object-cover max-h-screen' /></a>
